...
function AuthProvider({
    ...
    useEffect(() => {
        (async function () {
            ...
            let admin = await contract.methods
                .getAdmin()
            ...
            if (admin.email)
                ...
                let buyer = await contract.methods
                .getBuyer()
                .call({ from: accounts[0] });
            if (buyer.con)
                userAdd({
                    ...
                    role: buyer.role,
                    type: buyer.typ,
                    landdetails: buyer.landdetails,
                    fertilizersused: buyer.fertilizersused,
                    noofcrops: buyer.noofcrops,
                    verified: buyer.verified
                });
                let seller = await contract.methods
                .getSeller()
                .call({ from: accounts[0] });
            if (seller.con)
                userAdd({
